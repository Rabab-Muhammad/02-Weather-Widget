  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gradient-to-r from-blue-500 to-purple-600">
      <Card className="w-full max-w-md mx-auto text-center bg-white shadow-lg rounded-lg p-6">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-gray-800 mb-2">Weather Widget</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSearch} className="flex items-center gap-2 mb-4">
            ...
            <Button type="submit" disabled={isLoading}
             className="px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 disabled:bg-gray-400 transition duration-300"
            >
